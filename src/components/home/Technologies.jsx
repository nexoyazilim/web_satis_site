  ...
  const technologies = [
    {
      ...
      icon: <img src="/technologyicons/react.png" alt="React" className="w-10 h-10" />,
    ...
    },
    {
      ...
      icon: <img src="/technologyicons/aws.png" alt="AWS" className="w-10 h-10" />,
    ...
    },
    {
      ...
      icon: <img src="/technologyicons/threejs.png" alt="Three.js" className="w-10 h-10" />,
    ...
    },
    {
      name: "Tailwind CSS",
      category: "Styling",
      icon: <img src="/technologyicons/tailwind.png" alt="Tailwind CSS" className="w-10 h-10" />,
    ...
    },
    {
      ...
      icon: <img src="/technologyicons/nodejs.png" alt="Node.js" className="w-10 h-10" />,
    ...
    },
    {
      name: "MongoDB",
      category: "Database",
      icon: <img src="/technologyicons/mongodb.png" alt="MongoDB" className="w-10 h-10" />,
    ...
    },
    {
      name: "Vite",
      category: "Build Tool",
      icon: <img src="/technologyicons/vite.png" alt="Vite" className="w-10 h-10" />,
    ...
    },
    {
      ...
      icon: <img src="/technologyicons/typescript.png" alt="TypeScript" className="w-10 h-10" />,
    ...
    },
    {
      ...
      icon: <img src="/technologyicons/googlecloud.png" alt="Google Cloud" className="w-10 h-10" />,
